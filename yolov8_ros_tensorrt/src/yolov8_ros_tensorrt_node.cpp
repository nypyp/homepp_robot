...
#include "yolov8_ros_tensorrt/yolov8.hpp"
#include "yolov8_ros_tensorrt/yolov7.hpp"
#include "chrono"
...
public:
    ...
    on_configure(const rclcpp_lifecycle::State&) {
        ...
        publisher_ = this->create_publisher<yolov8_msgs::msg::DetectionArray>(
            "/yolo/detections", 
            qos);
        ...
        subscription_ = this->create_subscription<sensor_msgs::msg::Image>(
            ...
            std::bind(&YOLOv8LifecycleNode::image_callback, this, std::placeholders::_1));
    ...
    void image_callback(const sensor_msgs::msg::Image::SharedPtr msg) {
        ...
        if (this->get_current_state().id() == lifecycle_msgs::msg::State::PRIMARY_STATE_ACTIVE) {
            ...
            try {
                ...
                yolov8->infer();
                yolov8->postprocess(objs, score_threshold);
...
int main(int argc, char **argv) {
    ...
    auto node = std::make_shared<YOLOv8LifecycleNode>();
